    ...
    public class JellequinProjectConfig : ProjectConfig
    {
        ...
        public override int DebugLaunch(uint grfLaunch)
        {
            ...
            string GetBuildPropertyValue(string name)
                => this.ProjectManager.BuildProject.Properties.FirstOrDefault(x => string.Equals(x.Name, name, StringComparison.Ordinal))?.EvaluatedValue
                   ?? this.ProjectManager.BuildProject.Items.FirstOrDefault(x => string.Equals(x.ItemType, name, StringComparison.Ordinal))?.EvaluatedInclude;
            ...
            /*DebugTargetInfo info = new DebugTargetInfo
            {
                ...
                Arguments = "/c dotnet "+GetBuildPropertyValue("IntermediateAssembly")
            };*/
            ...
            DebugTargetInfo info = new DebugTargetInfo
            {
                ...
                Arguments = GetBuildPropertyValue("IntermediateAssembly")
            };
