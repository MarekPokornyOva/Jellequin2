...
namespace Microsoft.CodeAnalysis
{
    ...
    internal class CvtResFile
    {
        ...
        static internal List<RESOURCE> ReadResFile(Stream stream)
        {
            ...
            if (initial32Bits != 0)
                throw new Exception("Stream does not begin with a null resource and is not in .RES format.");
            ...
            while (stream.Position < stream.Length)
            {
                ...
                {
                    throw new Exception(String.Format("Resource header beginning at offset 0x{0:x} is malformed.", stream.Position - 8));
	...
	internal static class Win32ResourceConversions
    {
		...
		internal static void AppendIconToResourceStream(Stream resStream, Stream iconStream)
		{
			...
			if (reserved != 0)
				throw new Exception("CodeAnalysisResources.IconStreamUnexpectedFormat");
		 ...
		 * Dev10 alink had the following fallback behavior.
				  ...
				  */
		#region AppendVersionToResourceStream
		...
		//}
		#endregion AppendVersionToResourceStream
		...
		#region VersionResourceSerializer
        ...
        //    }
        //}
		#endregion VersionResourceSerializer
    }
}
